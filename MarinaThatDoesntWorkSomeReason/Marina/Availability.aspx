...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    ...
    <div class="d-flex">
        <div class="m-auto">
            <form id="form1" class="text-center container" runat="server">
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:CheckBox ID="water2" runat="server" onclick="return false;" Class="form-control" />
                        </div>
                        <div class="form-group">
                            <asp:Label ID="Label9" runat="server" Text="Electrical Services: "></asp:Label>
                            <asp:CheckBox ID="electric2" runat="server" onclick="return false;" Class="form-control" />
                        </div>
                    </div>
                </div>
            </form>
